  ...
  if (module.comingSoon) {
      return (
          <div className="flex flex-col items-center justify-center h-full p-8 text-center">
            ...
            <p className="mt-2 text-lg text-muted-foreground">This module is under construction and will be available soon!</p>
          </div>
      )
  }
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
       <div className="mb-8">
         ...
         <p className="mt-2 text-lg text-muted-foreground">Explore concepts, practice problems, and test your knowledge.</p>
       </div>
